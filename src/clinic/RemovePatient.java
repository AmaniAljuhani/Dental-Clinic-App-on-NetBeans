...
public class RemovePatient extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Information About Patient");

        table.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        table.getTableHeader().setFont(new Font("NewTimeRoman", Font.BOLD, 16));
        table.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "Name", "Age", "Phone Number", "Date", "Time", "Type", "Reason", "Doctor"
            }
        ) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        try {
            int c = JOptionPane.showConfirmDialog(null, "Do you want to remove this ?", "Select", JOptionPane.YES_NO_OPTION);
            if (c == 0) {
                DefaultTableModel model = (DefaultTableModel) table.getModel();
                Data.store.remove(table.getSelectedRow());
